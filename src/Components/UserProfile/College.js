  ...
  return (
    <div className="details">
      ...
      <div className="data-and-button">
        ...
        />
        <AiFillEdit
          className="editfield college"
          onClick={() => editField("college")}
        />
      </div>
      ...
      <div className="data-and-button">
        <input
          className="detailsdata applicationId"
          name="applicationId"
          value={person.applicationId}
          onChange={handleChange}
          readOnly
        />
        <AiFillEdit
          className="editfield applicationId"
          onClick={() => editField("applicationId")}
        />
      </div>
    </div>
  );
