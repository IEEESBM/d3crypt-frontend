    ...
    axios
      ...
      .then(
        (response) => {
          ...
          console.log(data)
          axios.post("http://localhost:4000/user-img",data).then((res)=>window.location.reload())
        },
        (error) => {
          console.log(error);
        }
     ...
     await axios
        ...
        .then(
          (response) => {
            ...
            axios.get("http://localhost:4000/image/"+response.data.imgKey).then((res)=>(console.log(res.data)))
